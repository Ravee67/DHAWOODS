    ...
    <div className="bg-sandal min-h-screen">
      ...
      <div className="bg-white py-16 sm:py-24 px-4 border-b border-sandal relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center container-px relative z-10">
          ...
          >
            Explore our curated selection of firewood-cooked briyanis and authentic BBQ.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-16 sm:py-24 px-4 space-y-24 sm:space-y-32">
        {menuData.map((cat, idx) => (
          ...
          >
            ...
            {/* Category Items - Minimal Pill-Style Cards (Synced with Order Now) */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cat.items.map((item, i) => (
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-sandal hover:border-brand-orange/30 transition-all duration-300 text-left flex items-center cursor-default"
                >
